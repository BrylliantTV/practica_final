...
public class Flight {
    ...
    public Flight(Integer id, String flightNumber, Date departureDate, Date arrivalDate, Time departureTime, Time arrivalTime, int duration, double price, Airline airline) {
        this.id = id;
